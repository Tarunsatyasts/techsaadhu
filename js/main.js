    ...
    if (clock.length) {
        if (clock.hasClass('js-timer-elapsed')) {
            ...
            clock.countdown(date + ' 12:00:00').on('update.countdown', function(event) {
                var output = [
                    '<div class="counter-container"><div class="counter-box first"><div class="number highlight">%-D</div><span>Day%!d</span></div>', //Days
                    '<div class="counter-box"><div class="number highlight">%H</div><span>Hours</span></div>', //Hours
                    '<div class="counter-box"><div class="number highlight">%M</div><span>Minutes</span></div>', //Minutes
                    '<div class="counter-box last"><div class="number highlight">%S</div><span>Seconds</span></div></div>' //Seconds
                ].join('\n');
                $(this).html(
                    event.strftime(output)
                );
